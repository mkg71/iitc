// ==UserScript==
// @id             iitc-plugin-draw-tools-MERGE@mkg71
// @name           IITC plugin: draw tools MERGE
// @category       Layer
...
// extended version of Jon Atkin Draw Tool From
// https://secure.jonatkins.com/iitc/release/plugins/draw-tools.user.js
// added MERGE option, instead of just PASTE (where all existing data is cleared)
...
//TODO: add line style choosers: thickness, maybe dash styles?
           ...
           + '<a onclick="window.plugin.drawTools.optPaste();return false;" tabindex="0">Paste & Reset Drawn Items</a>'
// ADDED: MERGE - MKG
		   +'<a onclick="window.plugin.drawTools.optMerge();return false;" tabindex="0">Paste & Merge Drawn Items</a>'
...
window.plugin.drawTools.optMerge = function() {
  var promptAction = prompt('Press CTRL+V to paste (and Merge) it.', '');
  if(promptAction !== null && promptAction !== '') {
    try {
      var data = JSON.parse(promptAction);
      window.plugin.drawTools.import(data);
      console.log('DRAWTOOLS: merge imported drawn items');
      window.plugin.drawTools.optAlert('Import and Merge Successful.');
...
window.plugin.drawTools.optPaste = function() {
  var promptAction = prompt('Press CTRL+V to paste (and RESET) it.', '');
  if(promptAction !== null && promptAction !== '') {
    try {
      var data = JSON.parse(promptAction);
      ...
      window.plugin.drawTools.optAlert('Import and Reset Successful.');
